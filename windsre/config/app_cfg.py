# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in 4windsre.
...
from windsre.lib import app_globals, helpers 
...
base_config.model = windsre.model
base_config.DBSession = windsre.model.DBSession
# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "22190f11-f46b-4344-89db-9caa88474e9a"
